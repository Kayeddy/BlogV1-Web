...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      <h3 className="text-xl mb-8 font-semibold border-b pb-4">Comment area</h3>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <textarea
          ...
          className="p-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-100 bg-gray-200 text-gray-700"
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        <input
          ...
          className="p-2 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-100 bg-gray-200 text-gray-700"
        />
        <input
          type="text"
          ref={commentatorEmail}
      ...
      <div className="grid grid-cols-1 gap-4 my-5">
        <div className="flex align-center gap-2">
          ...
          <label htmlFor="storeData" className="text-gray-500 cursor-pointer">
            {" "}
            Save email and name for future comments{" "}
          </label>
        </div>
      </div>
      ...
      {error && (
        <p className="text-xs text-red-500">
          {" "}
          In order to leave a comment all fields must be filled out.{" "}
        </p>
      )}
      ...
      <div className="mt-8 text-center">
        <button
          ...
          className="transition duration-500 ease-in-out hover:bg-indigo-900 inline-block text-white bg-pink-600 text-lg rounded-full p-3 cursor-pointer"
        >
          Post comment
        </button>
        {showSuccessMessage && (
